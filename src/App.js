...
class App extends React.Component {
  constructor(props) {
    ...
    this.operInput = this.numInput.bind(this);
    this.decInput = this.numInput.bind(this);
    this.clearInput = this.numInput.bind(this);
    this.calculate = this.numInput.bind(this);
  }
  numInput(e){
